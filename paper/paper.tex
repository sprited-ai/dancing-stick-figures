...
axis in latent space, where 1{,}024 tokens make all three mechanisms essentially cost-matched ($0.17$ vs.\
$0.19$\,s/step measured for the two attention extremes); at pixel scale joint attention costs $4.7\times$ the
factorised step in measured wall-clock, and the step-matched pixel-scale runs are deferred to a revision. The second axis varies the representation: matched DiTs
trained in the
...
Latent video DiT, 10k & factorised + local mixer & random & --- & --- & --- & --- & --- & --- & --- \\
