#!/bin/bash
# gin overnight 2026-08-17: image-first. Keep ia64/ib64 (64² image models) alive; when both are done, resume a64 (video UNet), then b64 fresh.
...
DONE[ia64]=30000; DONE[ib64]=30000; DONE[a64]=85000; DONE[b64]=85000
for r in ia64 ib64 a64 b64; do N[$r]=0; done
...
while true; do
  if [ $phase = img ]; then
    ...
    if ! running ia64 && ! running ib64; then log "image phase over -> video phase"; phase=vid; fi
  else
    ensure a64
