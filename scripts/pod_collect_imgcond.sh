...
cd /Users/jin/dev/dancing-stick-figure; POD=orxs5jje9daz7z; H="root@47.47.180.21"; S="ssh -o ConnectTimeout=30 -o BatchMode=yes -p 10053"; D=pod_results/imgcond; mkdir -p $D
t0=$(date +%s)
